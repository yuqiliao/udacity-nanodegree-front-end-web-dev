...
// LOAD DATA
Promise.all([
    d3.json("epirls/data/data1"),
    d3.json("epirls/data/data2"),
    d3.json("epirls/data/data3"),
    d3.json("epirls/data/data4"),
    d3.json("epirls/data/data5"),
    d3.json("epirls/data/data6")
]).then(results => {
